...
export function BookingModalFixed({ isOpen, onClose }: BookingModalProps) {
  ...
  const modalContent = (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative z-[10000] p-4 w-full max-w-2xl">
        <div className="bg-white dark:bg-zinc-900 rounded-2xl max-h-[90vh] overflow-hidden animate-scale-in shadow-2xl">
          {/* Header */}
          <div className="p-6 border-b border-gray-200 dark:border-zinc-800 flex items-center justify-between sticky top-0 bg-white dark:bg-zinc-900 z-10">
            <div>
  ...
  // Render as portal to ensure it's on top
